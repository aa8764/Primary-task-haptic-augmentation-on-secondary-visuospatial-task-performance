...
handedness = 'R';
Condition = nominal('No Nudge'); % Condition = nominal('NoNudge');
trial = 3;
...
for trial = 1:Nback_trials
    ...
    if trial == 1
        DrawFormattedText(window, 'Welcome to the experiment \n\n Press the space bar to select when 2 back was the same square highlighted. \n\n Please respond within three seconds, no responce or an incorrect responnce will be an error \n\n Press Any Key To Begin',...
            'center', 'center', white);
...
save('Participant001_Trial003_NoNudge.mat','Pos_DS','Nback_DS','Demographics');
